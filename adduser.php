...
if ($fail == "")
{ echo "</head><body>Form data successfully validated: $forename, $surname, $username, $password, Sage, $email.</body></html>";
...
function validateAge(field) {
  if (isNaN(field)) return "No Age was entered.\n"
   else if (field < 18 l] field > 110)
   return "Age must be between 18 and 110.\n"
   return ""
 }
function validateEmail(field) {
  if (field == "") return "No Email was entered.\n"
   else if (!((field.index0f(".") > 0) &&
          (field.index0f("@") > 0)) ||
...
if ($field == "") return "No Username was entered<br>";
 ...
 else if (preg_match("/[Aa-zA-Z0-9_-]/", $field))
...
function validate_email($field) {
  if ($field == "") return "No Email was entered<br>";
              ...
              (strpos($field, "@") > 0)) ||
              preg_match("KAa-zA-Z0-9.@_-]/", Sfield))
